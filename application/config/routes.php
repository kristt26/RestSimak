...
$route['api/dosenampu/bymk/:any'] = 'api/DosenPengampu/bymk';
...
$route['api/addmahasiswa'] = 'api/Mahasiswa/AddMahasiswa';
$route['api/getadd'] = 'api/Mahasiswa/GetAdd';
...
$route['api/Khsm/progress']['get'] = 'api/Khsm/GetProgress';
...
$route['api/StatusDaftar']['get'] = 'api/MahasiswaWali/GetStatusDaftar';
...
$route['api/MahasiswaMonitoring/mahasiswaProdi']['get'] = 'api/MahasiswaMonitoring/Prodi';
...
$route['api/dosen_wali/read']['get'] = 'api/DosenWali/read';
...
$route['v2/ipkmhs/:num']['get'] = 'api/v2/Mahasiswa/GetIPKMhs';
...
$route['api/v2/jadwal/jadwal_by_prodi']['get'] = 'api/Jadwal/jadwalByProdi';
$route['v2/sendmail']['get'] = 'api/v2/SendMail/send';
